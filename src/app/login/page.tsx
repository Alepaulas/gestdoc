  ...
  return (
    <div className="bg-white rounded-2xl p-8 shadow-2xl">
      ...
      {isDomainError && (
        <div className="flex items-start gap-3 bg-red-50 border border-red-200 rounded-xl p-4 mb-5">
          ...
          <div>
            ...
            <p className="text-xs text-red-600 mt-0.5">Este sistema aceita apenas contas do domínio institucional. Use seu e-mail corporativo.</p>
          </div>
        </div>
      )}
      ...
      <div className="flex items-center gap-2 mt-4 p-3 bg-slate-50 rounded-xl">
        ...
        <p className="text-xs text-slate-400">Acesso restrito ao domínio institucional</p>
      </div>
    </div>
  );
}
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 flex">
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-16 text-white">
        ...
        <div>
          ...
          <p className="text-slate-400 text-lg mb-10">Mapa de conformidade automático, fluxo de aprovação, leitura obrigatória e geração de Word.</p>
