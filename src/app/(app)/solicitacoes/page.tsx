...
const COLS_TABELA = [
  "ASSUNTO","REMETENTE","E-MAIL DO SOLICITANTE","STATUS","RESPONSÁVEL",
  "DATA DE PADRONIZAÇÃO","DATA DE PUBLICAÇÃO","QDE DE DOCUMENTOS","DESCONFORMIDADES",
];

const COLS_DETALHE = [
  "DESTINATÁRIO","E-MAIL DO SOLICITANTE","IMPORTADO EM","TEMPO DE PADRONIZAÇÃO","CONFORMIDADE COM O PRAZO","PRAZO MÁXIMO PARA PADRONIZAÇÃO",
