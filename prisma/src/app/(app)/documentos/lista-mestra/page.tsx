          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm">
              <thead className="bg-slate-50 border-b border-slate-200">
                <tr>
                  {["ID","Tipo","Nível","Código","Título","Unidade","Setor","Status Demanda","Validade","Dias","Próx. Revisão","Versão","Publicado em","Elaborador","Aprovador","Tempo Validação","Tempo Padronização","Aguardando Assinatura","Obs"].map(h => (
